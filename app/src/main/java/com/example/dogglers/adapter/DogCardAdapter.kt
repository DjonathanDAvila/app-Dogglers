...
class DogCardAdapter(
    ...
    class DogCardViewHolder(view: View?): RecyclerView.ViewHolder(view!!) {
        ...
        val dog_hobbies: TextView = view!!.findViewById(R.id.dog_hoobies)
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): DogCardViewHolder {
        ...
        val view: View = if (layout == Layout.GRID) {
    ...
    override fun onBindViewHolder(holder: DogCardViewHolder, position: Int) {
        ...
        holder.dog_age.text = context?.getString(R.string.dog_age, dog.age)
        holder.dog_hobbies.text = context?.getString(R.string.dog_hobbies, dog.hobbies)
